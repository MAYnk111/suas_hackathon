...
import 'package:sudha_app/pregnancy_role/presentation/widgets/customizable_dashboard.dart';
import 'package:sudha_app/pregnancy_role/presentation/widgets/kick_counter_widget.dart';
import 'package:sudha_app/pregnancy_role/presentation/widgets/contraction_timer_widget.dart';
import 'package:sudha_app/pregnancy_role/presentation/pages/hospital_bag_page.dart';
import 'package:sudha_app/pregnancy_role/presentation/pages/symptom_tracker_page.dart';
import 'package:sudha_app/pregnancy_role/presentation/pages/daily_tips_page.dart';
import 'package:sudha_app/pregnancy_role/presentation/viewmodels/user_meta_provider.dart';
import 'package:sudha_app/pregnancy_role/presentation/widgets/start_journey_widget.dart';

import 'package:sudha_app/pregnancy_role/presentation/pages/daily_summary_page.dart';
import 'package:sudha_app/pregnancy_role/presentation/pages/weekly_stats_page.dart';
...
class PregnantDashboardPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    print('DEBUG PregnantDashboardPage: Building dashboard...');
    return CustomizableDashboard(
      header: _buildHeader(context, ref),
      cardBuilder: (context, card) {
        print('DEBUG PregnantDashboardPage: Building card ${card.widgetType}');
  ...
  Widget _buildHeader(BuildContext context, WidgetRef ref) {
    ...
    print('DEBUG _buildHeader: username=$username, displayName=$displayName, startDate=${userMeta.startDate}');
        ...
        children: [
          ...
          if (userMeta.startDate != null) 
            ...
            Container(
              ...
              child: Text(
                'Complete pregnancy setup to track your journey',
  ...
  Widget _buildCardContent(BuildContext context, DashboardCardModel card) {
    ...
    print('DEBUG _buildCardContent: card.widgetType=${card.widgetType}, card.isVisible=${card.isVisible}');
    
    // Use theme primary/secondary colors instead of random materials
    
    switch (card.widgetType) {
      case 'pregnancy_progress':
        print('DEBUG _buildCardContent: Building pregnancy_progress card');
