...
import 'package:sudha_app/pregnancy_role/presentation/pages/growth_tracking_page.dart';
import 'package:sudha_app/pregnancy_role/presentation/pages/vaccination_page.dart';
import 'package:sudha_app/pregnancy_role/presentation/pages/nutrition_guidance_page.dart';
import 'package:sudha_app/pregnancy_role/presentation/pages/disease_awareness_page.dart';
...
import 'package:sudha_app/pregnancy_role/presentation/pages/careflow_ai_page.dart';
          ...
          ElevatedButton(
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Setup is available through profile settings')),
              );
            },
            child: const Text('Journey Settings'),
          ),
        ],
      ),
    );
